...
var fileDescriptor_2216fe83c9c12408 = []byte{
	...
	0x56, 0xd7, 0xdc, 0x82, 0x92, 0x4a, 0xa3, 0x56, 0x46, 0x2e, 0x26, 0xef, 0x30, 0x21, 0x1d, 0x2e,
	0x66, 0xf7, 0xd4, 0x12, 0x21, 0x41, 0x88, 0x03, 0xf5, 0x10, 0xce, 0x92, 0x12, 0x42, 0x16, 0x82,
	0xba, 0x44, 0x8d, 0x8b, 0x39, 0xa0, 0x14, 0xa1, 0x1a, 0x61, 0xbf, 0x14, 0x0f, 0x54, 0x08, 0x6c,
	0xb8, 0x90, 0x26, 0x17, 0xab, 0x53, 0x6a, 0x5e, 0x72, 0x86, 0x10, 0x8a, 0x30, 0x36, 0x23, 0x93,
	0xd8, 0xc0, 0x42, 0xc6, 0x80, 0x00, 0x00, 0x00, 0xff, 0xff, 0x5a, 0x5e, 0xd3, 0x65, 0x25, 0x01,
	0x00, 0x00,
}
...
type KVClient interface {
	...
	Bench(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*GetResponse, error)
}
...
func (c *kVClient) Bench(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*GetResponse, error) {
	out := new(GetResponse)
	err := c.cc.Invoke(ctx, "/proto.KV/Bench", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type KVServer interface {
	...
	Bench(context.Context, *Empty) (*GetResponse, error)
}
...
func _KV_Bench_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(KVServer).Bench(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.KV/Bench",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(KVServer).Bench(ctx, req.(*Empty))
	}
	return interceptor(ctx, in, info, handler)
}
